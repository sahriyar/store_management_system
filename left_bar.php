<h5 class="bg-primary text-white px-2 py-1">Category</h5>
                    ...
                    <h5 class="bg-primary text-white px-2 py-1">Product</h5>
                    <ul class="list-group m-2">
                        <li class="list-group-item">
                    ...
                    <h5 class="bg-primary text-white px-2 py-1">Store Product</h5>
                    <ul class="list-group m-2">
                        <li class="list-group-item">
                    ...
                    <h5 class="bg-primary text-white px-2 py-1">Spend Product</h5>
                    <ul class="list-group m-2">
                        <li class="list-group-item">
                    ...
                    <h5 class="bg-primary text-white px-2 py-1">Report</h5>
                    <ul class="list-group m-2">
                        <li class="list-group-item">
                            <a href="report.php" class="text-dark text-decoration-none">Report</a>
                        </li>
                    </ul>
                    <h5 class="bg-primary text-white px-2 py-1">Users</h5>
                    <ul class="list-group m-2">
                        <li class="list-group-item">
                            <a href="add_users.php" class="text-dark text-decoration-none">Add Users</a>
                        </li>
                        <li class="list-group-item">
